...
// const TableModels = mongoose.model("Table", tableSchema);
// export default TableModels;


import mongoose from "mongoose";

const TableModelsSchema = new mongoose.Schema({}, { strict: false });

const TableModels = mongoose.model("TableModels", TableModelsSchema);
